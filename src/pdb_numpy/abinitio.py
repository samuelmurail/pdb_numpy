...
BACK_ANGLE = [['N', 'CA', 'C', 110.9],
              ...
              ['CA', 'C', 'N', 110.9],
              ['CA', 'N', 'C', 121.3],
              ['N', 'C', 'O', 119.0]]  # Only for ACE-connection
...
BACK_DIHE = [['N', 'CA', 'C', 'O', 0],
             ...
             ['CA', 'N', 'C', 'O', 0.0]]  # Only for ACE-connection
        ...
        for atom_name in AA_ATOM_DICT[res_name]:
            ...
            if atom_num == 0:
                ...
                if atom_num > 1:
                    ...
                    angle = find_angle(res_name, atom_name,
                                            connect_name, connect_2_name)
                ...
                if atom_num > 2:
                    if connect_2_index not in connect_dict:
                        ...
                        connect_3_name =\
                            pep.name[connect_3_index]
                        dihe = find_dihe_angle(res_name, atom_name,
                                                    connect_name,
                                                    connect_2_name,
                                                    connect_3_name)
                        ...
                        vec_1 = pep.xyz[connect_index] -\
                            pep.xyz[connect_2_index]
                        vec_2 = pep.xyz[connect_index] -\
                            pep.xyz[connect_3_index]
